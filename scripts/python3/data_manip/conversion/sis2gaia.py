...
def sis2gaia_parser(subparser):
    ...
    parser = subparser.add_parser("sis2gaia",\
            help="Conversion of the steering file from SISYPHE to GAIA")
...
def sis2gaia(sis_cas_file, gaia_cas_file):
    ...
    trans_key = {\
      ...
      'SOLVER OPTION FOR SUSPENSION':'SOLVER OPTION FOR DIFFUSION OF SUSPENSION',
      'PRECONDITIONING FOR SUSPENSION':'PRECONDITIONING FOR DIFFUSION OF SUSPENSION',
      'SOLVER ACCURACY FOR SUSPENSION':'ACCURACY FOR DIFFUSION OF SUSPENSION',
      'SUSPENSION':'SUSPENSION FOR ALL SANDS',
      'REFERENCE CONCENTRATION FORMULA':'SUSPENSION TRANSPORT FORMULA FOR ALL SANDS',
      'TETA SUSPENSION':'TETA IMPLICITATION FOR SUSPENSION',
      'CRITICAL SHEAR VELOCITY FOR MUD DEPOSION':'CLASSES CRITICAL SHEAR STRESS FOR MUD DEPOSITION',
      ...
      'INITIAL FRACTION FOR PARTICULAR SIZE CLASS':'CLASSES INTITIAL FRACTION',
      'PARTHENIADES CONSTANT':'LAYERS PARTHENIADES CONSTANT',
      'MUD CONCENTRATION PER LAYER':'LAYERS MUD CONCENTRATION',
      'CRITICAL EROSION SHEAR STRESS OF THE MUD':'LAYERS CRITICAL EROSION SHEAR STRESS OF THE MUD',
